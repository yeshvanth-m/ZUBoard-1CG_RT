...
# Path of this script: E:\CODE\Vitis_Workspace\AES128_Benchmark_RT_system\_ide\scripts\systemdebugger_aes128_benchmark_rt_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source E:\CODE\Vitis_Workspace\AES128_Benchmark_RT_system\_ide\scripts\systemdebugger_aes128_benchmark_rt_system_standalone.tcl
# 
...
set bp_4_35_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_4_35_fsbl_bp
targets -set -nocase -filter {name =~ "*R5*#0"}
rst -processor
