...
# Path of this script: E:\CODE\Vitis_Workspace\AES128_Benchmark_system\_ide\scripts\debugger_aes128_benchmark-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source E:\CODE\Vitis_Workspace\AES128_Benchmark_system\_ide\scripts\debugger_aes128_benchmark-default.tcl
# 
...
set bp_0_16_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_0_16_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
